...
const feed = async (req, res) => {
  ...
  try {
    ...
    return res.status(200).json({
      status: "success",
      message: "Listado de las publicaciones de mi feed:",
    ...
    return res.status(404).json({
      status: "Error",
      message:
        "No hay listado de las publicaciones del feed, para poder ver las publicaciones tiene que crear al menos una",
    });
  }
};
module.exports = {
