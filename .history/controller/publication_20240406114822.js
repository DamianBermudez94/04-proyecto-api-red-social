...
const upLoad = async (req, res) => {
  try {
    ...
    let publicationUpdate = await Publication.find(
      { user: req.user.id,user:req._id.publicationId},
    ...
    console.log("soy la imagen que quiero actualizar", publicationUpdate.file);
