...
router.post("/upload/:id",userAuth.auth,[uploads.single("file0")],publicatiionController.upLoad);
router.get("/imagen/:fichero",userAuth.auth,publicatiionController.media);
/*
